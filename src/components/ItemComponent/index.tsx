...
export default class ItemComponent extends React.Component<Props> {
    ...
    render() {
        return (
            <View style={{padding:18, width:"100%", flexDirection: "row", backgroundColor:"white", marginTop: 10, marginBottom: 10, borderBottomWidth:1.5, borderColor:"#e6e6e6"}}>
                ...
                <View style={{flex:10, height:"100%" /* , backgroundColor:"pink" */, alignItems: "flex-start", marginLeft:18}}>
                        ...
                        <View style={{backgroundColor:"#e6e6e6" , position:"absolute", right:0, top:0}}>
